...
# Simulated Pix keys for suppliers
SUPPLIER_PIX_KEYS = {
...
def export_pix_batch():
    ...
    # Select all APPROVED purchases to be processed into batch
    ...
    # Update purchases in DB to avoid double processing
    for order in approved_purchases:
        cursor.execute(
    ...
    print(f"💰 Valor Total do Lote: R$ {api_payload['valor_total_lote']:.2f}")
